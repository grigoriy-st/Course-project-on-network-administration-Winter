...
Центр правовой защиты населения эксплуатирует компьютерную сеть с выделенным сервером на первом, втором и 
третьем этажах здания. Компьютерная сеть имеет гостевой беспроводной сегмент. 

Сотрудники обеспечены доступом к сети Интернет в кабинетах и на прилегающей территории.
...
Доступ к глобальной сети Интернет осуществляется с помощью услуг провайдера Дом.ru. 
...
Создать сетевые конфигурации обеспечивающие: организацию потоков трафика согласно матрицы доступа (ACL), средства отказоустойчивости, средства защиты, мониторинг устройств (Zabbix) и их удаленное управление. Произвести тестирование сети.
